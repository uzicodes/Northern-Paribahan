            ...
            <div className="w-full max-w-md">
                ...
                <div className="w-full bg-white rounded-3xl shadow-xl p-7 sm:p-9 border border-black/5">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-xs sm:text-sm text-gray-500 mt-1">Sign in to manage your tickets and journeys</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3 my-4 sm:my-5">
                        ...
                        <span className="text-[11px] uppercase tracking-wider text-gray-400 font-bold">Or continue with email</span>
                        <div className="flex-grow h-px bg-gray-200"></div>
                    </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1.5">
                                ...
                                <Link 
                                    ...
                                    className="text-xs font-semibold text-[#172144] hover:text-[#FCA311] hover:underline transition-colors"
                                >
                                    Forgot Password?
                                </Link>
                            </div>
